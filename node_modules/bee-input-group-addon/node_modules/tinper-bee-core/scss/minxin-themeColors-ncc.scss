...
// 主题色
$primary-color: $palette-red-500 !default;
$primary-color-dark: $palette-red-700 !default;
$primary-color-light: $palette-red-300 !default;
...
$item-hover-bg-color-base: $palette-red-50 !default;
